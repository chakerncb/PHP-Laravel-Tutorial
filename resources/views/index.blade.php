                    ...
                    <div class="col-xxl-5">
                        ...
                        <div class="text-center text-xxl-start">
                            ...
                            <div
                                ...
                                <a class="btn btn-outline-dark btn-lg px-5 py-3 fs-6 fw-bolder" style="color: #1A29CF;"
                                    href="{{route('home')}}">Start with me ></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-7">
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-xxl-8">
                        {{-- <div class="text-center my-5">
                            ...
                            <p class="lead fw-light mb-4">We are {{ config('app.name') }} and we help brands grow.</p>
